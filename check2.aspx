<%@ Page Language="C#" AutoEventWireup="true" CodeFile="check2.aspx.cs" Inherits="check2" %>
...
<body>
        ...
        <div class="text-muted" >
            <nav class="navbar navbar-default " style="background-color:#ffd800/*opacity:0.5*/">
                <div class="navbar-header" >
                    ...
                    <a id="logo" class="navbar-brand" href="Index.aspx">check2(症狀就醫參考表)</a>
                </div>
    ...
    <div>
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="account,serial_num,symptom_reference_num" DataSourceID="SqlDataSource1">
            <EditItemTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HomeCare1ConnectionString %>" SelectCommand="SELECT * FROM [check2]"
            InsertCommand="insert into [check2]( account, serial_num , symptom_reference_num) values(@account,@serial_num,@symptom_reference_num) "
            
            DeleteCommand="delete from [check2] where  account=@ account and   serial_num=@serial_num and symptom_reference_num=@symptom_reference_num  " 
             >
            <DeleteParameters>
                <asp:Parameter />
