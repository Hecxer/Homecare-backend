<%@ Page Language="C#" AutoEventWireup="true" CodeFile="check3.aspx.cs" Inherits="check3" %>
...
<body>
    <form id="form2" runat="server">
      ...
      <div class="container" >
        <div class="text-muted" >
            <nav class="navbar navbar-default " style="background-color:#ffd800/*opacity:0.5*/">
                <div class="navbar-header" >
                    ...
                    <a id="logo" class="navbar-brand" href="Index.aspx">check3(健康文章)</a>
                </div>
        ...
        <div>
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="account,serial_num,h_articleNum" DataSourceID="SqlDataSource1">
                <EditItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HomeCare1ConnectionString %>" SelectCommand="SELECT * FROM [check3]"
                     InsertCommand="insert into [check3]( account, serial_num , h_articleNumLabel) values(@account,@serial_num,@h_articleNumLabel) "  
                
            DeleteCommand="delete from [check3] where  account=@account and   serial_num=@serial_num and h_articleNum=@h_articleNum  " 
                >
                <DeleteParameters>
                ...
                <InsertParameters>
                    <asp:Parameter Name="account" />
                    <asp:Parameter Name="serial_num" />
                    <asp:Parameter Name="h_articleNumLabel" />
                </InsertParameters>
            </asp:SqlDataSource>
